...
import app_cliente_en_joyeria.composeapp.generated.resources.Inter_18pt_Regular
...
fun CustomTheme(content: @Composable () -> Unit) {
    val typography = Typography().defaultFontFamily(FontFamily(Font(Res.font.Inter_18pt_Regular)))
